...
function checkingMinMax(string $fish_name)
{
    $min = 2;
    $max = 10;
...
function searchList(string $fish_name, array $fishes_list)
{
...
function orderFish(string $fish_name, string $fish_count)
{
    ...
    $min_max_checking  = checkingMinMax($fish_name);
    $list_search       = searchList($fish_name, $fishes_list);
    return "$type_checking_str $type_checking_int $min_max_checking $list_search";
}
//Business Logic
